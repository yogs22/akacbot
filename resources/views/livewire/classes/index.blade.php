...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Tambah Kelas</button>
            ...
            <table class="table-fixed w-full">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="px-4 py-2">Sub Kelas</th>
                ...
                <tbody>
                    @forelse($classes as $row)
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{ $row->sub }}</td>
