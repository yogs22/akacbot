...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Tambah Data Orang Tua</button>

            @if($isModal)
                @include('livewire.parents.create')
            @endif
                ...
                <tbody>
                    @forelse($parents as $row)
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{ $row->relation }}</td>
