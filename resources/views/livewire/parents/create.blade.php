            ...
            <form wire:submit.prevent="store()">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formGender" wire:model="relation">
                            <option value=""></option>
                            <option value="Ayah">Ayah</option>
                            <option value="Ibu">Ibu</option>
                            <option value="Lainnya">Lainnya</option>
                        </select>
                        @error('relation') <span class="text-red-500">{{ $message }}</span>@enderror
                    </div>
                </div>
